...
\Large __Publications__\footnote{Authors in italics were students or post-docs at the time the research was completed.}
...
_DeFilippo LB_, _Buehrens TW_, __Scheuerell MD__, Kendall NW, Schindler DE. In review. Improving short-term recruitment forecasts for coho salmon using a spatiotemporal integrated population model

_Webster A_, Douglas T, Harms TK, Regier P, __Scheuerell MD__. In review. Multi-scale temporal patterns in stream biogeochemistry indicate linked permafrost and ecological dynamics of boreal catchments

_McGowan DW_, Branch TA, Haught S, __Scheuerell MD__. In review. Multi-decadal shifts in the distribution and timing of Pacific herring (_Clupea pallasii_) spawning in Prince William Sound, Alaska

Jankowski K, Houser JN, __Scheuerell MD__, Smits AP. In review. Warmer winters increase phytoplankton biomass in a large floodplain river
...
NOAA National Oceanographic Partnership Program ($199k) 2020-2022. Advancing sustainable shellfish aquaculture through machine learning and automated data collection on fish communities (Co-PI with Sanderson, Ferris)
...
=======
>>>>>>> 53a589989f9c48cc515366d7a797d7822736957a
